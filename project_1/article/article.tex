...
\section{Results}
	...
	\begin{table}
		\caption{Analytic result. $N=1$, 1D, $2\times10^6$ cycles.}
		\centering
		\begin{tabular}{ccc} \hline
			\alpha & E($\alpha$) & $\sigma^2$(E) \\ \hline \hline
				0.30 & 0.5717 & 0.1504 \\
				0.34 & 0.5397 & 0.0815 \\
				0.38 & 0.5197 & 0.0390 \\
				0.42 & 0.5084 & 0.0154 \\
				...
				0.62 & 0.5114 & 0.0239 \\
				0.66 & 0.5203 & 0.0381 \\
				0.70 & 0.5275 & 0.0590 \\ \hline \hline			
		\end{tabular}	
	\end{table}
	
	\begin{table}
		\caption{Numerical result. $N=1$, 1D, $2\times10^6$ cycles.}
		\centering
		\begin{tabular}{ccc} \hline
			\alpha & E($\alpha$) & $\sigma^2$(E) \\ \hline \hline
				0.30 & 0.5807 & 0.2535 \\
				...
				0.62 & 0.5481 & 0.0221 \\
				0.66 & 0.5481 & 0.0194 \\
				0.70 & 0.5596 & 0.0204 \\ \hline \hline
		\end{tabular}
	\end{table}
...
\begin{figure}[h]
	\makebox[\textwidth][c]{
	\includegraphics[width=1.2\textwidth]{../figures/problem_b.png}
	}
\end{figure}
