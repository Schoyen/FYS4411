...
\section{Algorithms}
    ...
    \subsection{The Metropolis-Hastings Algorithm}
        ...
        \subsubsection{Initial distribution of particles}
            Prior to performing the Metropolis-Hastings algorithm we have to an
            initial distribution of the particles. As the algorithm is supposed
            to move particles in the right direction this distribution can be
            \emph{somewhat} arbitrary. There are however a few caveats to this
            approach.
            ...
            \begin{enumerate}
                ...
                \item The initial \emph{spread} of the particles is too small or
                    ...
                    something that can happen to the interacting system as an
                    overlap between the particles makes the wavefunction
                    evaluate to zero thus rejecting all steps in the ratio test.
                    The latter can lead to the system never reaching a true
                    state as they are scattered too far away from the
                    interesting regions in the configuration space.
