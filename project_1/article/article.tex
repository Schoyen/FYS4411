...
\subsection{Non-interacting harmonic oscillators}
    ...
    \begin{align}
        ...
        \Biggr).
    \end{align}
    In natural units, $\hbar = c = 1$, and with the mass set to unity, $m = 1$,
    this reduces to
    \begin{align}
        E_L(\vf{r})
        &=
    ...
    \end{align}
    It is worth noting that for $\alpha = \omega/2$\footnote{Note that $\alpha$
    is required to be positive.} we get a stable value for the local energy.
    \begin{align}
        E_L(\vf{r})
        &\equiv
        E_L
    ...
    \subsubsection{Exact variational energy}
        ...
        \end{align}
        which in natural units reduces to $\alpha_0 = \omega/2$. The energy at
