...
\section{Theory}
    ...
    \subsection{Interacting hard sphere bosons}
        ...
        \begin{align}
            ...
            \equiv u_{jk}
        \end{align}
        The drift force for particle $k$ for this system becomes
        \begin{align}
            \vf{F}_k(\vf{r})
            &=
            2\Biggl(
        ...
        \end{align}
        We will avoid writing out the full expression for the local energy for
        this system due to the size of the equation.
