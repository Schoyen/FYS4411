    ...
    \subsection{Constructing the matrix elements}
        ...
        \subsubsection{Constructing the Hartree-Fock basis}
            ...
            \begin{equation}
                ...
                %F_{pq} = H_{pq} +  J(D)_{pq} - \frac{1}{2}K(D)_{pq},
            \end{equation}
            ...
            \begin{equation}
                FC = SC\varepsilon.
            \end{equation}
            This is a generalised eigenvalue problem where
            \begin{align}
                S^{p}_{q} = \braket{p}{q},
            \end{align}
...
\section{Implementation}
    ...
    \subsection{Installation and Usage}
        ...
        install with \mintinline{bash}{make installr} instead.
