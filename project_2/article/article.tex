    ...
    \subsection{Coupled cluster amplitude equations}
			...
			\bra{\Phi_{ij}^{ab}} &(V_N)\ket{\Phi_0} \\
			 ...
			 \bra{\Phi_0}\{a_i^\dagger a_j^\dagger a_ba_a\}\{a^\dagger_pa^\dagger_qa_sa_r\}\ket{\Phi_0} \\
			     ...
			     &\ -\delta_{ap}\delta_{bq}\delta_{jr}\delta_{is}
			 	 +\delta_{aq}\delta_{bp}\delta_{jr}\delta_{is}) = \bra{ab}\ket{ij}.
		\end{aligned}
		\end{equation}
		...
		\begin{aligned}
			\bra{\Phi_{ij}^{ab}}&F_NT_2\ket{\Phi_0} \\
				=& \sum_{pq}\sum_{klcd}f_{pq}t_{kl}^{cd} \bra{\Phi_0}
					\{a_i^\dagger a_j^\dagger a_b a_a \}(\{a^\dagger_pa_q \}\{a^\dagger_c a^\dagger_d a_l a_k \})_c \ket{\Phi_0} \\
				=& \sum_{pq}\sum_{klcd}f_{pq}\bra{pq}\ket{rs} t_{kl}^{cd} \\
				\times \Big(
		        ...
		        + &\{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c5 a^\dagger_p \c5 a_q \c3 a^\dagger_c \c4 a^\dagger_d \c1 a_l \c2 a_k } \}
		          + \{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c5 a^\dagger_p \c5 a_q \c3 a^\dagger_c \c4 a^\dagger_d \c2 a_l \c1 a_k } \} \\
		        + &\{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c5 a^\dagger_p \c5 a_q \c4 a^\dagger_c \c3 a^\dagger_d \c1 a_l \c2 a_k } \}
		          + \{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c5 a^\dagger_p \c5 a_q \c4 a^\dagger_c \c3 a^\dagger_d \c2 a_l \c1 a_k } \} \\
		        + &\{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c3 a^\dagger_p \c1 a_q \c5 a^\dagger_c \c4 a^\dagger_d \c2 a_l \c5 a_k } \}
		     	 + 	\{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c3 a^\dagger_p \c2 a_q \c5 a^\dagger_c \c4 a^\dagger_d \c1 a_l \c5 a_k } \} \\
		        + &\{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c4 a^\dagger_p \c1 a_q \c5 a^\dagger_c \c3 a^\dagger_d \c2 a_l \c5 a_k } \}
		          + \{\wick{\c1 a^\dagger_i \c2 a^\dagger_j \c3 a_b \c4 a_a \c4 a^\dagger_p \c2 a_q \c5 a^\dagger_c \c3 a^\dagger_d \c1 a_l \c5 a_k } \} \\
				...
				\Big) \\
				=& \sum_{pq}\sum_{klcd}f_{pq}\bra{pq}\ket{rs} t_{kl}^{cd} \\
				&\times(\delta_{a c} \delta_{b d} \delta_{i k} \delta_{i q} \delta_{j l} \delta_{p q} - \delta_{a c} \delta_{b d} \delta_{i k} \delta_{j q} \delta_{l p}\\
				 \ &- \delta_{a c} \delta_{b d} \delta_{i l} \delta_{i q} \delta_{j k} \delta_{p q} + \delta_{a c} \delta_{b d} \delta_{i l} \delta_{j q} \delta_{k p}  \\
				 ...
				 \ &- \delta_{a d} \delta_{b c} \delta_{i k} \delta_{i q} \delta_{j l} \delta_{p q} + \delta_{a d} \delta_{b c} \delta_{i k} \delta_{j q} \delta_{l p} \\
				 \ &+ \delta_{a d} \delta_{b c} \delta_{i l} \delta_{i q} \delta_{j k} \delta_{p q} - \delta_{a d} \delta_{b c} \delta_{i l} \delta_{j q} \delta_{k p} \\
