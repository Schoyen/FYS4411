...
\section{Theory}
    ...
    \subsection{Quantum Dots}
        ...
        Some consideration should be given towards why the system described above
        is a quantum dot, and why we should care about quantum dots.
        ...
        relatively easy to build in a laboratory. Here, some free electrons are 
        ...
        \autoref{eq:eq:two_body_operator}, and with we approximate the confining
        potential by the harmonic oscillator potential, given by the second term
        in the one-body Hamiltonian in \autoref{eq:eq:one_body_hamiltonian}. The
    ...
    \subsection{Constructing the matrix elements}
        ...
        \subsubsection{Constructing the Hartree-Fock basis}
            ...
            Because the Hartree-Fock method is a variational method, the initial
            wavefunction made up of the single-partrice wavefunctions $\varphi_i$
            ...
            a Harmonic Oscillator (HO) basis we can transform into a better basis, called the
            ...
            both the HO basis and the HF basis.
...
\section{Discussion}
    ...
    \subsection{Performance comparison}
        ...
        with the HO basis. This effect is only apparent in system with a larger
        ...
        the particles are subject to. I other words, the HO basis fits rather
        well. 
