...
\section{Implementation}
    ...
    \subsection{Program Structure}
        ...
        The first subsection, \mintinline{bash}{matrix_elemtents},
        ...
        The \mintinline{bash}{hartree_fock} subsection contains methods
        ...
        The \mintinline{bash}{schemes} subsection is arguably the most important
        ...
        intelligent ways. First, \mintinline{python}{CoupledClusterDoubles} is
        ...
        matrix CCD solver in \mintinline{python}{CoupledClusterDoublesSparse}.
        Third, \mintinline{python}{CoupledClusterDoublesOptimized} is
    ...
    \subsection{Implementation details}
        ...
        \mintinline{python}{CoupledClusterDoublesOptimized} we make use of the
        ...
        including but not limited to \mintinline{python}{numpy.einsum},
        \mintinline{python}{numpy.tensordot}, and reshaping datastructures to
        two dimensions and using \mintinline{python}{numpy.matmul}.
        Additionally, we tried to make use of the python package
        \mintinline{python}{dask} which allows for arrays that are larger than
        ...
        using \mintinline{python}{numba} for paralellization of some
